...
import { 
  ...
  RefreshCw, Heart, FileSpreadsheet, Send
} from 'lucide-react';
...
const TRENDING_PRODUCTS = [
  { 
    ...
    label: '综合最优',
    data: { totalScore: 94, tag: '高潜爆款', trend: 45, lifecycle: '增长期', season: '四季', competitorCount: 12, monopoly: '低', price: 299, margin: 65, profit: 150000, roi: 1.5, returnRate: 3.2, risk: '低', uspCount: 5 }
  },
  { 
    rank: 2, 
    id: 'P-002', 
    ...
    label: '热度最优',
    data: { totalScore: 78, tag: '红海稳健', trend: 12, lifecycle: '成熟期', season: '四季', competitorCount: 85, monopoly: '高', price: 89, margin: 40, profit: 45000, roi: 2.8, returnRate: 2.5, risk: '低', uspCount: 2 }
  },
  { 
    rank: 3, 
    id: 'P-003', 
    ...
    label: '潜力最大',
    data: { totalScore: 82, tag: '季节爆品', trend: 120, lifecycle: '爆发期', season: '夏季', competitorCount: 32, monopoly: '中', price: 129, margin: 55, profit: 82000, roi: 1.8, returnRate: 5.5, risk: '中', uspCount: 3 }
  }
];
        ...
        <TabsContent value="benchmarking" className="m-0 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-4">
            ...
            <div className="flex items-center justify-center">
              <Button variant="ghost" size="sm" className="text-[10px] text-slate-400 hover:text-rose-500" onClick={() => { setCompareList([]); showSuccess("已清空对比队列"); }}>
                清空对比
              </Button>
            </div>
          </div>
